...
// ---------------------------------------------------------------------------
// Structured import (zip): merge blueprints carrying their own category/subcategory
// names into the tree, creating categories/subcategories on demand and merging by
// name into existing ones. Used by the zip import flow.
// ---------------------------------------------------------------------------
